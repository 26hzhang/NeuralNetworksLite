package com.isaac.neuralnetworks.dialogue;
...
public class CorpusIterator implements MultiDataSetIterator {
     ...
     * I want to checkpoint the network, show intermediate test results and some stats, it would be harder to achieve
     * with listeners I think so this is how I solved the problem. This way the learn process is asynchronous inside
     * one macrobatch and synchronous across all the macrobatches.
     * 
     * Macrobatch is a group of minibatches. The iterator is modified so that it reports the end of data when it exhausts
     * a macrobatch. Then it advances (manually) to the next macrobatch.
     */
