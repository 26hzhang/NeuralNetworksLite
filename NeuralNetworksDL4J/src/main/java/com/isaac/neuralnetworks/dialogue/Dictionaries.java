...
public class Dictionaries {
     ...
     */
    public static final List<List<Double>> corpus = new ArrayList<>();

    public static void createDictionary(String CORPUS_FILENAME, int ROW_SIZE) throws IOException {
        double idx = 3.0;
        dict.put("<unk>", 0.0);
        revDict.put(0.0, "<unk>");
        dict.put("<eos>", 1.0);
    ...
    private static String obtainFilePath(String path) {
        return "src/main/resources/dialogue/" + path;
    }
}
