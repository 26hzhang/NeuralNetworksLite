...
import com.isaac.neuralnetworks.sentimentrnn.DataUtilities;
import com.isaac.neuralnetworks.sentimentrnn.SentimentExampleIterator;
...
/**Example: Given a movie review (raw text), classify that movie review as either positive or negative based on 
...
public class Word2VecSentimentRNN {
	...
	//		"dl4j_w2vSentiment/");
	private static final String DATA_PATH = FilenameUtils.concat("/Users/zhanghao/Desktop",
			"dl4j_w2vSentiment/");
	/** Location (local file system) for the Google News vectors. Set this manually. */
	//private static final String WORD_VECTORS_PATH = "/PATH/TO/YOUR/VECTORS/GoogleNews-vectors-negative300.bin.gz";
	private static String WORD_VECTORS_PATH = "/PATH/TO/YOUR/VECTORS/GoogleNews-vectors-negative300.bin.gz";

	public static void main(String[] args) throws Exception {
		if(WORD_VECTORS_PATH.startsWith("/PATH/TO/YOUR/VECTORS/")){
			WORD_VECTORS_PATH = "/Users/zhanghao/Documents/Files/GoogleNews-vectors-negative300.bin.gz";
