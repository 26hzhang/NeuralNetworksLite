...
import com.isaac.neuralnetworks.stockpred.PlotUtil;
import com.isaac.neuralnetworks.stockpred.PriceCategory;
import com.isaac.neuralnetworks.stockpred.RecurrentNets;
import com.isaac.neuralnetworks.stockpred.StockDataSetIterator;
...
public class StockPricePrediction {
    ...
    public static void main (String[] args) throws IOException {
        String file = new ClassPathResource("stocks/prices-split-adjusted.csv").getFile().getAbsolutePath();
        ...
        File locationToSave = new File("src/main/resources/stocks/StockPriceLSTM_".concat(String.valueOf(category)).concat(".zip"));
