...
public class ConvNNAnimalsClassification {
    public static final Logger log = LoggerFactory.getLogger(ConvNNAnimalsClassification.class);

    private static int height = 100;
    private static int width = 100;
    private static int channels = 3;
    protected static int numExamples = 80;
    private static int numLabels = 4;
    ...
    private void run(String[] args) throws Exception {
         ...
         **/
        InputSplit[] inputSplit = fileSplit.sample(pathFilter, numExamples * (1 + splitTrainTest),
        ...
        if (save) {
            log.info("Save model....");
            String basePath = FilenameUtils.concat(System.getProperty("user.dir"), "src/main/java/resources/");
    ...
    private MultiLayerNetwork lenetModel() {
        /*
         * Revise Lenet Model approach developed by ramgo2 achieves slightly above random
    ...
    public static void main(String[] args) throws Exception {
        new ConvNNAnimalsClassification().run(args);
    }
}

/**
 * Examples labeled as bear classified by model as bear: 1 times
 * Examples labeled as bear classified by model as duck: 1 times
 * Examples labeled as deer classified by model as duck: 2 times
 * Examples labeled as duck classified by model as bear: 2 times
 * Examples labeled as turtle classified by model as duck: 1 times
 * Examples labeled as turtle classified by model as turtle: 1 times
 * ==========================Scores========================================
 * Accuracy:        0.25
 * Precision:       0.4444
 * Recall:          0.25
