package com.isaac.dl4j.regression;
...
public class RegressionSum {
    /** From https://github.com/deeplearning4j/dl4j-examples/blob/master/dl4j-examples/src/main/java/org/deeplearning4j/examples/feedforward/regression/RegressionSum.java*/
